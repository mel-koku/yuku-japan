...
export const CITY_PAGE_DATA: Record<KnownCityId, CityPageData> = {
  ...
  miyama: {
    ...
    description:
      "Miyama is a mountain valley in Nantan City, north of central Kyoto, where Kayabuki no Sato — the thatched village — preserves around 38 farmhouses with kayabuki roofs of densely packed susuki grass, the highest concentration of intact thatched architecture in Japan. The village was named an Important Preservation District in 1993 and remains a working farming community: the same families maintain the roofs (a kayabuki roof needs full replacement every 20 to 30 years, in a community-organized roof-raising). Twice a year, in May and December, a fire drill turns the entire village into a fountain of water as 62 hidden hydrants test simultaneously — the photograph that defines Miyama for most visitors. The Miyama Folk Museum, the Little Indigo Museum (Hiroyuki Shindo's private collection of indigo textiles in a 1796 thatched farmhouse), and Chii Hachimangū round out the day. About ten of the thatched houses operate as overnight minshuku. From Kyoto, take JR to Sonobe Station, then Nantan City Bus to Kita; budget around 2 hours each way.",
    ogDescription:
